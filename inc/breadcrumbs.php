...
function ct_ignite_breadcrumbs() {
	...
	if ( !is_front_page() ) {
		...
		echo '<div id="' . $breadcrumbs_id . '" class="' . $breadcrumbs_classes . '">';

		// Home page
		echo '<span class="item-home"><a class="bread-link bread-home" href="' . esc_url( get_home_url() ) . '" title="' . esc_attr( $home_title ) . '">' . esc_attr( $home_title ) . '</a></span>';
		echo '<span class="separator separator-home"> ' . esc_attr( $separator ) . ' </span>';
